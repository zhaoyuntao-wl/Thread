import { ThreadStore, queryMemory, queryEvents, THREAD_VERSION } from "@thread/core";
...
// description 内置契约段（不变量 #11 契约载体分层主通道）：
// 模型只需记住"需要历史/上下文/不确定时调用本工具"，不编造；结果带引用。
