...
6. **B⑦ 场景级保真回归集**（新）：跨压缩保真场景入回归（decision-chain / repeat-question / goal-retention / compact-fidelity / injection-follow / scope-filter / migration-lossless / rebuild-recovery），`pnpm eval` 入 CI 门禁
